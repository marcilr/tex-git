...
%% git remote add
\input{remotes/commands/git-remote-add.tex}

%% git remote set-url
\input{remotes/commands/git-remote-set-url.tex}

%% git remote rename
\input{remotes/commands/git-remote-rename.tex}

%% git remote rm
\input{remotes/commands/git-remote-rm.tex}

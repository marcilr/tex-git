...
%% git remote add
\input{repositories/remotes/commands/git-remote-add.tex}

%% git remote set-url
\input{repositories/remotes/commands/git-remote-set-url.tex}

%% git remote rename
\input{repositories/remotes/commands/git-remote-rename.tex}

%% git remote rm
\input{repositories/remotes/commands/git-remote-rm.tex}

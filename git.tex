...
You can also not specify a user, and Git assumes the user you're currently logged in as.\footnote{
...
it's generally easy to set up and use.\footnote{Ibid.}
\\
\\
